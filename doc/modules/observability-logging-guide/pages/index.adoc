...
To dive deeper into MDC and how to enrich your logs with contextual information, see our introduction guide on logging: xref:application-logging:index.adoc#context-information-in-logs[Application Logging in Jmix: Context Information in Logs].
